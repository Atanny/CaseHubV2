...
const SESSION_ROW_COLS = ['Case Type', 'Case Number', 'Account Number', 'Combine Tracker', 'QA Checklist', 'Status', 'Action'];

function SessionRowHeader() {
  return (
    <div className="grid grid-cols-7 gap-2.5 px-4 py-2.5 rounded-ch">
      {SESSION_ROW_COLS.map((c) => (
...
/** One case row in the Session Log grid table, matching Figma's 7-column grid exactly. */
function SessionRow({ row, onView }) {
