const ICONS = {
  ...
  'radio-unchecked': (c) => <circle cx="8" cy="8" r="6.5" stroke={c} strokeWidth="1.5" />,
  chevron: (c) => <path d="M4 6l4 4 4-4" stroke={c} strokeWidth="1.6" strokeLinecap="square" strokeLinejoin="round" fill="none" />,
};
